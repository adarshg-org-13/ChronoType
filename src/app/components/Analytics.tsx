...
export const Analytics = ({ history, onReset }: { history: Array<{ wpm: number, accuracy: number, correctChars: number, incorrectChars: number, date: string, mode: TestMode }>, onReset: () => void }) => {
  if (history.length === 0) {
    return (
      <div 
        className="text-center text-muted mt-12 font-mono flex flex-col items-center justify-center h-64 w-300 mx-auto border border-dashed border-muted/30 rounded-2xl duration-300"
      >
